...
} from '@/domain/evolution/autoEvolveConcept';
import { detectEvolution } from '@/domain/evolution/detectEvolution';
import type { EvolutionConfig } from '@/domain/evolution/types';
